...
<section class="our-publication pt-100 pb-70">
            <div class="container">
                <div class="section-header">
                    ...
                    <h2>WHY US?</h2>
                    <p>WatchMart is an official stockist for all watch brands listed on this website. WatchMart is a leading retailer of brand name designer watches and is also the India's most popular watch website*. WatchMart was the first independent watch retailer to advertise on national television, and we pride ourselves on having one of the most efficient shopping systems available with communication at every stage to inform you of your order status, as well as excellent 7-days sales, customer service and support team who are glad to assist you with any enquiry.</p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3"> 
                        <div class="single-publication">
                            ...
                            <div class="publication-content">
                                <span class="category">Digital Watch</span>
                                <h3><a href="#">Casio</a></h3>
                                <ul>
                                    <li><i class="icofont-star"></i></li>
                                    <li><i class="icofont-star"></i></li>
                                    <li><i class="icofont-star"></i></li>
                    ...
                    <div class="col-sm-6 col-lg-3"> 
                        <div class="single-publication">
                            ...
                            <div class="publication-content">
                                <span class="category">Kids Watch</span>
                                <h3><a href="#">Fastrack</a></h3>
                                <ul>
                                    <li><i class="icofont-star"></i></li>
                                    <li><i class="icofont-star"></i></li>
                                    <li><i class="icofont-star"></i></li>
                    ...
                    <div class="col-sm-6 col-lg-3"> 
                        <div class="single-publication">
                            ...
                            <div class="publication-content">
                                <span class="category">Ladies Watch</span>
                                <h3><a href="#">Sonata</a></h3>
                                <ul>
                                    <li><i class="icofont-star"></i></li>
                                    <li><i class="icofont-star"></i></li>
                                    <li><i class="icofont-star"></i></li>
