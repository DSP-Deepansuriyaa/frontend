          ...
          <div class="row">
               ...
               <div class="col-md-12 col-sm-12">
                    ...
                    <div class="wow fadeInUp section-title" data-wow-delay="0.2s">
                         <h2>Get in touch</h2>
                         <p>If you have any queries regarding our products, We are here to help you out</p>
                    </div>
               </div>
               ...
               <div class="col-md-5 col-sm-8">
                    ...
                    <div class="wow fadeInUp contact-info" data-wow-delay="0.4s">
                         <div class="section-title">
                              <h2>Contact Info</h2>
                              <p>We are to help you out!! Our services will be available 24x7</p>
                         </div>
                         
                         <p><i class="fa fa-map-marker"></i> 456 New Street 22000, New York City, USA</p>
                         <p><i class="fa fa-comment"></i> <a href="mailto:info@company.com">WatchMart@company.com</a></p>
